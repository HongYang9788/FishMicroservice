...
yolact_fish_dataset = dataset_base.copy({
    'name': 'Yolact Fish Dataset',

    'valid_info': './data/coco/annotations/image_info_test-dev2017.json',
    'has_gt': False,

    'label_map': NEWFISH_16_CLASSES
})
...
yolact_fish_config = yolact_base_config.copy({
    'max_size': 768,
    'num_classes': 17,
})

# Default config
cfg = yolact_fish_config.copy()
